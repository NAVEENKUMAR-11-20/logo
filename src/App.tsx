        ...
        <section className="py-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="group p-8 text-center hover:bg-gray-50 dark:hover:bg-gray-800 rounded-2xl transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Typography</h3>
                <p className="text-gray-600 dark:text-gray-300">
                  Mastery of font selection, custom lettering, and typographic hierarchy to create 
                  compelling wordmarks and combination logos.
                </p>
              </div>
              ...
              <div className="group p-8 text-center hover:bg-gray-50 dark:hover:bg-gray-800 rounded-2xl transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Color Theory</h3>
                <p className="text-gray-600 dark:text-gray-300">
                  Deep understanding of color psychology, harmony, and application across different 
              ...
              <div className="group p-8 text-center hover:bg-gray-50 dark:hover:bg-gray-800 rounded-2xl transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Adobe Illustrator</h3>
                <p className="text-gray-600 dark:text-gray-300">
                  Expert-level proficiency in vector graphics creation, ensuring scalable and 
                  professional logo designs for any application.
                </p>
              </div>

              <div className="group p-8 text-center hover:bg-gray-50 dark:hover:bg-gray-800 rounded-2xl transition-all duration-300">
                <div className="w-20 h-20 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
                  <Figma className="w-10 h-10 text-white" />
                </div>
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Figma</h3>
                <p className="text-gray-600 dark:text-gray-300">
                  Modern design workflows with collaborative tools for prototyping, iteration, 
                  and seamless client feedback integration.
                </p>
              </div>
              ...
              <div className="group p-8 text-center hover:bg-gray-50 dark:hover:bg-gray-800 rounded-2xl transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Brand Strategy</h3>
                <p className="text-gray-600 dark:text-gray-300">
                  Strategic thinking to align visual design with business goals, target audience, 
                  and market positioning for maximum impact.
                </p>
              </div>
            </div>
          </div>
